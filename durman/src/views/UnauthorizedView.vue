<template>
  <a  target="_blank" style="background-color: #181828;" class="bg-gray-900">
<header class="top-header">

</header>
<div style="background-color: #00BCD4;" class="button-container-1 z-40  absolute right-[40%]">
      <span class="mas">Atras</span>
    <button id='work' type="button" name="Hover" @click="$router.push('/')">Volver</button>
  </div>
...
<div class="error__content">
  <div class="error__message message">
    <h1 class="message__title">Acceso Denegado</h1>
    <p class="message__text"> you are not authorized to access this page</p>
  </div>
...
/* Botón 2: máscara diferente */

/* Botón 3: máscara diferente */
